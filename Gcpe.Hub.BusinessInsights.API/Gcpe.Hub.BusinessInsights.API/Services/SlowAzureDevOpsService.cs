...
{
    public class SlowAzureDevOpsService : IAzureDevOpsService
    {
        private readonly IConfiguration _config;
        public SlowAzureDevOpsService(IConfiguration config)
        {
            _config = config;
        }
        ...
        private async Task<List<WorkItem>> GetWorkItems(string organizationUrl, string personalAccessToken, string projectName)
        {
            ...
            var workItemTypeResponse = await response.Content.ReadFromJsonAsync<WorkItemTypeResponse>();
