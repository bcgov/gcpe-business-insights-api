...
namespace Gcpe.Hub.BusinessInsights.API.Services
{
    public interface IHubBusinessInsightsRepository
    {
        ...
        Task<IEnumerable<NewsReleaseEntity>> GetAllNewsReleasesAsync();
        Task<IEnumerable<NewsReleaseEntity>> GetNewsReleasesInDateRangeAsync(string startDate = "", string endDate = "");
